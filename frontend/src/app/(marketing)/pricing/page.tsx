      ...
      <div className="max-w-5xl mx-auto">
        ...
        <ScrollReveal stagger={150}>
          <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            {/* Professional */}
            <div
              className="sr-item p-8 rounded-xl flex flex-col transition-all duration-300 hover:translate-y-[-2px] hover:shadow-lg hover:shadow-emerald-500/5"
              style={{
            ...
            >
              ...
              <Link
                href="/register"
                className="block w-full py-3 rounded-md text-sm font-medium text-center transition-colors hover:brightness-110"
