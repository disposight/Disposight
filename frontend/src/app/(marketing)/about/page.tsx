...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://disposight.com/about",
    ...
    <>
      ...
      <ScrollReveal>
        <section className="max-w-3xl mx-auto px-4 sm:px-6 pb-16 sm:pb-24">
          <div
            className="p-6 sm:p-8 rounded-xl transition-all duration-300 hover:translate-y-[-2px] hover:shadow-lg hover:shadow-emerald-500/5"
            style={{
        ...
        <section className="max-w-5xl mx-auto px-4 sm:px-6 pb-16 sm:pb-24">
          ...
          <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
            {pipelines.map((pipe) => (
              <div
                key={pipe.title}
                className="sr-item p-6 rounded-xl transition-all duration-300 hover:translate-y-[-2px] hover:shadow-lg hover:shadow-emerald-500/5"
                style={{
                  backgroundColor: "var(--bg-surface)",
                  border: "1px solid var(--border-default)",
                }}
        ...
        <section className="max-w-3xl mx-auto px-4 sm:px-6 pb-16 sm:pb-24">
          ...
          <div className="space-y-4">
            {[
              ...
              <div
                key={item.title}
                className="sr-item p-5 rounded-xl transition-all duration-300 hover:translate-y-[-2px] hover:shadow-lg hover:shadow-emerald-500/5"
                style={{
                  backgroundColor: "var(--bg-surface)",
                  border: "1px solid var(--border-default)",
                }}
