...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://disposight.com/contact",
    ...
    <>
      ...
      <ScrollReveal stagger={120}>
        <section className="max-w-2xl mx-auto px-4 sm:px-6 pb-16 sm:pb-24">
          ...
          <div
            className="mt-6 p-5 rounded-xl text-center transition-all duration-300 hover:shadow-lg hover:shadow-emerald-500/5"
            style={{
              backgroundColor: "var(--bg-surface)",
              border: "1px solid var(--border-default)",
            }}
